...
return (
    ...
    <div className="fav-wrapper absolute top-10 left-10" id={props.id} onClick={props.onFavClick} style={{height: '32px', width:'32px', position: "absolute", top: '10px', left: "10px" }} > 
