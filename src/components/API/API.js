...
export const specificCountryUrl = code => {
  return `https://cors-anywhere.herokuapp.com/https://api.musixmatch.com/ws/1.1/chart.tracks.get?chart_name=top&page=1&page_size=5&country=${code}&f_has_lyrics=1%20&%20apikey=${apiKey}`;
}